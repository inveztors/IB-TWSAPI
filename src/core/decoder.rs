...
impl Decoder {
    ...
    fn process_smart_components(&mut self, fields: &[String]) -> Result<(), IBKRApiLibError> {
        ...
        for _ in 0..count {
            let smart_component = SmartComponent {
